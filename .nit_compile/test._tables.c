...
void CHECKNEW_FDStream(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_fd", LOCATE_test, 0);
  }
  stack_frame_head = fra.me.prev;
}
val_t NEW_FDStream_stream___FDStream___init(val_t p0){
...
void CHECKNEW_FDIStream(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_eof", LOCATE_test, 0);
  }
  REGB0 = TAG_Bool(ATTR_stream___FDStream____fd(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
...
void CHECKNEW_FDOStream(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_is_writable", LOCATE_test, 0);
  }
  REGB0 = TAG_Bool(ATTR_stream___FDStream____fd(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
...
void CHECKNEW_Process(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_data", LOCATE_test, 0);
  }
  stack_frame_head = fra.me.prev;
}
val_t NEW_Process_exec___Process___init(val_t p0, val_t p1){
...
void CHECKNEW_IProcess(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_in", LOCATE_test, 0);
  }
  REGB0 = TAG_Bool(ATTR_exec___Process____data(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
...
void CHECKNEW_OProcess(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_out", LOCATE_test, 0);
  }
  REGB0 = TAG_Bool(ATTR_exec___Process____data(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
...
void CHECKNEW_Point(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_x", LOCATE_test, 0);
  }
  REGB0 = TAG_Bool(ATTR_figure___Point____y(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
    nit_abort("Uninitialized attribute %s", "_y", LOCATE_test, 0);
  }
  stack_frame_head = fra.me.prev;
}
val_t NEW_Point_figure___Point___init(val_t p0, val_t p1){
...
void CHECKNEW_Segment(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_sommets", LOCATE_test, 0);
  }
  stack_frame_head = fra.me.prev;
}
val_t NEW_Segment_figure___Segment___init(val_t p0){
...
void CHECKNEW_Cercle(val_t p0){
  ...
  if (UNTAG_Bool(REGB0)) {
    ...
    nit_abort("Uninitialized attribute %s", "_centre", LOCATE_test, 0);
  }
  REGB0 = TAG_Bool(ATTR_figure___Cercle____rayon(fra.me.REG[0])!=NIT_NULL);
  if (UNTAG_Bool(REGB0)) {
  } else {
    nit_abort("Uninitialized attribute %s", "_rayon", LOCATE_test, 0);
  }
  stack_frame_head = fra.me.prev;
}
val_t NEW_Cercle_figure___Cercle___init(val_t p0, val_t p1){
