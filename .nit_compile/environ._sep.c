...
val_t environ___Symbol___environ(val_t p0){
  ...
  fra.me.REG[0] = p0;
  /* /Users/tony/Projects/nit/lib/standard//environ.nit:22 */
  ...
  /* /Users/tony/Projects/nit/lib/standard//environ.nit:24 */
  if (!once_value_1) {
    if (!once_value_2) {
  ...
  fra.me.REG[1] = fra.me.REG[1];
  /* /Users/tony/Projects/nit/lib/standard//environ.nit:25 */
  ...
  if (UNTAG_Bool(REGB0)) {
    /* /Users/tony/Projects/nit/lib/standard//environ.nit:26 */
    fra.me.REG[0] = NEW_String_string___String___from_cstring(fra.me.REG[0]);
    goto label3;
  } else {
    /* /Users/tony/Projects/nit/lib/standard//environ.nit:28 */
    if (!once_value_4) {
      fra.me.REG[1] = BOX_NativeString("");
      REGB0 = TAG_Int(0);
      fra.me.REG[1] = NEW_String_string___String___with_native(fra.me.REG[1], REGB0);
...
val_t environ___NativeString___get_environ(val_t p0){
  ...
  fra.me.REG[0] = NIT_NULL;
  fra.me.REG[0] = p0;
  /* /Users/tony/Projects/nit/lib/standard//environ.nit:34 */
